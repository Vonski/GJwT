...
public class GirlOne : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject spawned = (GameObject)Instantiate(Resources.Load("Prefabs/Missile/Missile"), (Vector2)Camera.main.ScreenToWorldPoint(Input.mousePosition), new Quaternion(0f, 0f, 0f, 0f));
